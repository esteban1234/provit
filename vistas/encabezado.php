...
<head>
	<meta charset="UTF-8">
	<meta name="google-site-verification" content="nc8MT2f2CuV3OAMTslI2wcWqx7-KOXFL7Jmh0rRNbMg" />
	<link rel="icon" type="image/png" href="img/favicon.png" />
	<title>PROVIT ASESORES</title>
	 <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0"> 
  	<META NAME="Title" content="PROVIT ASESORES SA DE CV">
  	<META NAME="Author" CONTENT="[http://provitasesores.com/]"/>
